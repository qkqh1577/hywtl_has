...
public class ProjectReviewException extends CustomExceptionAdaptor {
    ...
    public enum ProjectReviewExceptionType {
        CONFIRMED_EXISTS("project_review.confirmed_exists", "이미 확정된 검토가 있습니다."),
        ALREADY_CONFIRMED("project_review.already_confirmed", "이미 확정된 검토입니다."),
        ALREADY_UNCONFIRMED("project_review.already_unconfirmed", "이미 확정 취소된 검토입니다.");
