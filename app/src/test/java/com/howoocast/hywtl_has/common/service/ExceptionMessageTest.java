...
public class ExceptionMessageTest {
    ...
    void test() {
        ...
        codeSet.add("project.estimate.sheet.project-review-id.not-null");
        ...
        codeSet.add("project-review.code.not-blank");
        codeSet.add("project-review.detail-list.not-empty");
        codeSet.add("project-review.detail.area.not-null");
        codeSet.add("project-review.detail.area.positive");
        codeSet.add("project-review.detail.base-count.for-test");
        codeSet.add("project-review.detail.building-name.not-blank");
        codeSet.add("project-review.detail.floor-count.not-null");
        codeSet.add("project-review.detail.height.not-null");
        codeSet.add("project-review.detail.height.positive");
        codeSet.add("project-review.detail.memo1.for-test");
        codeSet.add("project-review.detail.memo2.for-test");
        codeSet.add("project-review.detail.special-wind-load-condition-list.for-test");
        codeSet.add("project-review.detail.test-list.not-empty");
        codeSet.add("project-review.id.for-test");
        codeSet.add("project-review.status.not-null");
        codeSet.add("project-review.test-list.for-test");
