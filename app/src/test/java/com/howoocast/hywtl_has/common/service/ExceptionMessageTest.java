...
public class ExceptionMessageTest {
    ...
    void test() {
        ...
        codeSet.add("personnel.licence_list.for_test");
        codeSet.add("personnel_licence.note.for_test");
        codeSet.add("personnel_licence.name.not_blank");
        codeSet.add("personnel_licence.organization_name.not_blank");
        codeSet.add("personnel_licence.qualified_date.not_null");
        codeSet.add("personnel_licence.qualified_number.not_blank");
        codeSet.add("personnel_licence.type.for_test");
