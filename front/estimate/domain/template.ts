...
export type EstimateDetailTemplateId = number & { readonly _brand: unique symbol; }

export function EstimateDetailTemplateId(id: number) {
  return id as EstimateDetailTemplateId;
}


export interface EstimateDetailTemplateVO {
  id: EstimateDetailTemplateId;
  titleList: string[];
  unit: TestUnit | '';
  unitPrice: number | '';
  memo?: string;
...
export interface EstimateTemplateVO {
  ...
  title: string;
  testType: TestType | '';
  detailList: EstimateDetailTemplateVO[];
}
