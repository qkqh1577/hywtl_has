...
import {BusinessIdWithManagerId, BusinessShortVO, BusinessVO} from "../../../business/domain";

interface BusinessSelectorListProps {
  list: BusinessVO[] | undefined;
  loading: boolean,
  setBusiness: Dispatch<SetStateAction<BusinessIdWithManagerId>>
}
...
export default function BusinessSelectorList(props: BusinessSelectorListProps) {
  const {loading, list, setBusiness} = props;
